...
public class Management {
    ...
    void hireTest2() {
        ...
        for (Employee employee : employees) {
            ...
            System.out.println("Employee has a " + employee.vehicle().getVehicle());
            ...
            if (employee.vehicle() instanceof Car){
                System.out.println("\t- gear type: " + ((Car) employee.vehicle()).getGear());
                System.out.println("\t- type: " + ((Car) employee.vehicle()).getType());
            } else if (employee.vehicle() instanceof Motorcycle) {
                if(((Motorcycle) employee.vehicle()).isSideCar()){
